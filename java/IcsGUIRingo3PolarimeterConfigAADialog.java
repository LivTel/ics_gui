...
*/
// IcsGUIRingo3PolarimeterConfigAADialog.java
// $Header: /home/cjm/cvs/ics_gui/java/IcsGUIRingo3PolarimeterConfigAADialog.java,v 1.2 2020-05-05 10:20:39 cjm Exp $
import java.lang.*;
import java.util.*;
import java.awt.*;
...
/**
 * This class provides an Add and Amend facility for Ringo3 Polarimeter Configurations.
 * @author Chris Mottram
 * @version $Revision: 98404f49e4c35a5c59ab3678f31a3b1d35ba5297 $
 */
public class IcsGUIRingo3PolarimeterConfigAADialog extends JDialog implements ActionListener
{
	/**
	 * Revision Control System id string, showing the version of the Class.
	 */
	public final static String RCSID = new String("$Id: IcsGUIRingo3PolarimeterConfigAADialog.java | Tue May 5 10:20:41 2020 +0000 | Chris Mottram  $");
	/**
	 * Button height.
	 */
	 ...
	 */
	public IcsGUIRingo3PolarimeterConfigAADialog(Frame owner,IcsGUIConfigProperties c)
	{
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		// get and test numeric data from text fields
			try
			{
				...
				if(triggerTypeString.equals("external"))
					triggerType = Ringo3PolarimeterConfig.TRIGGER_TYPE_EXTERNAL;
				else if(triggerTypeString.equals("internal"))
					triggerType = Ringo3PolarimeterConfig.TRIGGER_TYPE_INTERNAL;
		...
		// set data
			...
			configProperties.setConfigType(configId,IcsGUIConfigProperties.
							CONFIG_TYPE_POLARIMETER_RINGO3);
...
// Revision 1.1  2012/03/16 12:19:52  cjm
// Initial revision
//
//
