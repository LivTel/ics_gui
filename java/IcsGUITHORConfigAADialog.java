...
public class IcsGUITHORConfigAADialog extends JDialog implements ActionListener
{
	 ...
	 */
	public final static String RCSID = new String("$Id: IcsGUITHORConfigAADialog.java | Tue May 5 10:20:41 2020 +0000 | Chris Mottram  $");
	/**
	 * Button height.
	 */
	 ...
	 */
	public IcsGUITHORConfigAADialog(Frame owner,IcsGUIConfigProperties c)
	{
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		int testId = 0;
		int i;
		int xBin,yBin,emGain,windowFlags;
