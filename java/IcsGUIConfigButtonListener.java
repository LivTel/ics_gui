...
*/
// IcsGUIConfigButtonListener.java
// $Header: /home/cjm/cvs/ics_gui/java/IcsGUIConfigButtonListener.java,v 0.6 2020-05-05 10:20:39 cjm Exp $
import java.lang.*;
import java.io.*;
import java.util.*;
import java.awt.*;
...
public class IcsGUIConfigButtonListener implements ActionListener
{
	 ...
	 * @param cd The instance of CONFIGDialog this listener is attached to.
	 * @see #parent
	 * @see #configListDialog
	 */
	public IcsGUIConfigButtonListener(IcsGUI p,CONFIGDialog cd)
	{
		super();
...
// Revision 0.5  2006/05/16 17:12:13  cjm
