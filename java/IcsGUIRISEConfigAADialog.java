...
*/
// IcsGUIRISEConfigAADialog.java
// $Header: /home/cjm/cvs/ics_gui/java/IcsGUIRISEConfigAADialog.java,v 1.2 2020-05-05 10:20:39 cjm Exp $
import java.lang.*;
import java.util.*;
import java.awt.*;
...
/**
 * This class provides an Add and Amend facility for RISE Configurations.
 * @author Chris Mottram
 * @version $Revision: 98404f49e4c35a5c59ab3678f31a3b1d35ba5297 $
 */
public class IcsGUIRISEConfigAADialog extends JDialog implements ActionListener
{
	/**
	 * Revision Control System id string, showing the version of the Class.
	 */
	public final static String RCSID = new String("$Id: IcsGUIRISEConfigAADialog.java | Tue May 5 10:20:41 2020 +0000 | Chris Mottram  $");
	/**
	 * Button height.
	 */
	 ...
	 */
	public IcsGUIRISEConfigAADialog(Frame owner,IcsGUIConfigProperties c)
	{
		super(owner,"Add/Amend RISE Configuration");
//		setResizable(false);
		configProperties = c;
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		// set data
			...
			configProperties.setConfigType(configId,IcsGUIConfigProperties.CONFIG_TYPE_CCD_RISE);
...
// Revision 1.1  2007/12/11 17:40:46  cjm
// Initial revision
//
//
