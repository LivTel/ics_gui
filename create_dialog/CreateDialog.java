// CreateDialog.java
// $Header: /home/cjm/cvs/ics_gui/create_dialog/CreateDialog.java,v 0.15 2002-12-10 16:34:45 cjm Exp $
import java.lang.*;
...
public class CreateDialog
{
	 ...
	 */
	public final static String RCSID = new String("$Id: CreateDialog.java,v 0.15 2002-12-10 16:34:45 cjm Exp $");
	/**
	...
	// DAY_CALIBRATE TWILIGHT_CALIBRATE
		labelHashtable.put("timeToComplete","Time to Complete");
	...
	// headers and imports
		outputStream.println("// "+getUnqualifiedClassName(inputClass.getName())+
			"Dialog.java");
		outputStream.println("// Generated by "+this.getClass().getName()+" : Version : $Revision: 0.15 $");
	...
	// setID method
		...
		outputStream.println("\t}");
	// if there is a field of class ngat.phase2.nonpersist.InstrumentConfig - add some special methods here
		if(configMethods)
		{
