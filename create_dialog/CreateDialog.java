...
*/
// CreateDialog.java
// $Header: /home/cjm/cvs/ics_gui/create_dialog/CreateDialog.java,v 0.28 2014-10-02 10:50:06 cjm Exp $
import java.lang.*;
...
public class CreateDialog
{
	 ...
	 */
	public final static String RCSID = new String("$Id: CreateDialog.java,v 0.28 2014-10-02 10:50:06 cjm Exp $");
	/**
	...
	// headers and imports
		outputStream.println("// "+getUnqualifiedClassName(inputClass.getName())+
			"Dialog.java");
		outputStream.println("// Generated by "+this.getClass().getName()+" : Version : $Revision: 0.28 $");
	...
	// if there is a field of class ngat.phase2.InstrumentConfig - add some special methods here
		...
		// setIcsGUIStatus method
			...
			outputStream.println("\t * @param s The instance of CcsGUIStatus to use.");
			outputStream.println("\t */");
			outputStream.println("\tpublic void setIcsGUIStatus(CcsGUIStatus s)");
			outputStream.println("\t{");
		...
		// getIcsGUIStatus method
			...
			outputStream.println("\t * @return The instance of CcsGUIStatus to use.");
			outputStream.println("\t */");
			outputStream.println("\tpublic CcsGUIStatus getIcsGUIStatus()");
			outputStream.println("\t{");
	 ...
	 * @param The output stream to write the license to.
	 */
	...
	private void writeFieldDeclaration(Field f,PrintStream os)
	{
		...
		if(f.getType().getName().equals("ngat.phase2.InstrumentConfig"))
		{
			...
			os.println("\t/**");
			os.println("\t * icsGUIStatus is a reference to the CcsGUIStatus object with properties.");
			os.println("\t */");
			os.println("\tprivate CcsGUIStatus icsGUIStatus;");
			configMethods = true;
		}
	}
