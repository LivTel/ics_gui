...
public class CreateDialog
{
	 ...
	 */
	public final static String RCSID = new String("$Id: CreateDialog.java,v 0.30 2020-05-05 10:19:25 cjm Exp $");
	/**
	...
	// headers and imports
		outputStream.println("// "+getUnqualifiedClassName(inputClass.getName())+
			"Dialog.java");
		outputStream.println("// Generated by "+this.getClass().getName()+" : Version : $Revision: 0.30 $");
